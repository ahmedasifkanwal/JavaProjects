...
<html class="">
    ...
    <head>
        ...
        <title>Banner1 - WiFi Login</title>
    ...
    <body>
        ...
        <jsp:include page="../layout/Header.jsp"></jsp:include>
            <div class="container-fluid">
                <!--  BANNER TOP SPACE -1 --> 
                <div class="row">
                    <!-- Slider (must add col-md-12 for bootstrap) -->
                        ...
                        <div class="add-space-1"><!-- innermost wrapper element -->
                            <div class="banner_space_1">
                                <a href="google.com"  target="_blank">
                                    <img class="slide img-fluid img-rounded" style="max-height: 120px" src="<%=request.getContextPath()%>/fixedtemplate/Banner1/includes/defaultImage/head-office-top.png" /> 
                            </a>
                            <a href="google.com"  target="_blank">
                                <img class="slide img-fluid img-rounded" style="max-height: 120px" src="<%=request.getContextPath()%>/fixedtemplate/Banner1/includes/defaultImage/head-office.png" /> 
                            </a>
                        </div>
                    </div>
            ...
            <!--  BANNER TOP SPACE -2 --> 
            <div class="row">
                <div class="col-md-9 slider" id="main-slider3"> <!--outermost container element -->
                    <div class="add-space-3"><!-- innermost wrapper element -->
                        <div class="banner_space_2">
                            <a href="google.com"  target="_blank">
                                <img class="slide img-fluid img-rounded" style="max-height: 255px" src="<%=request.getContextPath()%>/fixedtemplate/Banner1/includes/defaultImage/refreshed.png" >
                            </a>
                            <a  href="infocom.com">
                                <img class="slide img-fluid img-rounded" style="max-height: 255px" src="<%=request.getContextPath()%>/fixedtemplate/Banner1/includes/defaultImage/Footer.gif" >
                            </a>
                        </div>
                    </div>
                    <!-- <span class="txtSub">Text Here</span> -->
                    ...
                    <div class="col-md-11 dbg">
                        <form name="theform" id="theform" action="<%=controller%>"    method="post"    >
                            ...
                            <div class="start">
                                ...
                                <div id="error" class="main_error"> <%=result.getMessage()%> </div>
                                <%}%>


                                <div id="loginbox1">
                                    <span class="heading1">Select country code.</span> <div style="width:auto;height:5px"></div>     
                                    <span id="spryselect1">
                ...
                <div class="col-md-12 slider" id="main-slider2"> <!--outermost container element -->
                    <div class="add-space-2"><!-- innermost wrapper element -->
                        <div class="banner_space_3">
                            <a href="google.com"  target="_blank">
                                <img class="slide img-fluid img-rounded" style="max-height: 120px" src="<%=request.getContextPath()%>/fixedtemplate/Banner1/includes/defaultImage/head-office-top.png" class="band"> </a>
                            <a href="google.com"  target="_blank">
                                <img class="slide img-fluid img-rounded" style="max-height: 120px" src="<%=request.getContextPath()%>/fixedtemplate/Banner1/includes/defaultImage/head-office.png" class="band"> </a>
                        </div>
                    </div>
                    <!-- <span class="txtSub">Text Here</span> -->
                </div> 
        ...
        <footer style="background:white;color:black; height: 70px">
            <div id="row" class="footer">
                <div class="col-md-4 slider" id="main-slider2">  
                </div>
                <div class="col-md-5 slider" id="main-slider2" >
                    <span id="omantel"><img  style="max-height: 70px;alignment-adjust: central" src="<%=request.getContextPath()%>/fixedtemplate/Banner1/includes/defaultImage/Footer.gif"></span>
                </div> 
            </div>
        </footer>
        <script  type="text/javascript">
        setbanners('<%=commonAllPE.getString("lba.redirect.url")%>','<%=peLogin.getMacvlan()%>', '<%=peLogin.getVlan()%>', 'P1', 'LBA_BANNER', 'banner_space_1', 'banner_space_2', 'banner_space_3');
        </script>'
