...
<html>
    <head>
        ...
        <title>Wi-Fi Not available</title>
    </head>
            ...
            <div class="row" >
                <div class="col-md-12 dbg">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 echrowpad" style="margin-top: 3vh;">
                           <div class="frmTxt">
                            Please reopen browser window or <a href="http://ezxcess.antlabs.com/login.now">
                                Click here </a> to start new session </div>

                        <div class="frmTxt">
                            Please  <a href="http://ezxcess.antlabs.com/logout.now">
                                Click here </a> to logout </div>
                        </div>

                        <!-- Component 3--> 
                        <div class="col-md-2 echrowpadb" style="margin-top: 3vh;">
                            <input <%=peLogin.getPreviewSTyle()%>  id="Enter" name="Enter" type="submit" value="<%=appMsg.getString("f.enter")%>" class="inputButton inputbuttonm"  />
                        </div>

                        <!-- Component 4--> 
                        <div class="col-md-2 echrowpadb" style="margin-top: 3vh;"> 
                            <input <%=peLogin.getPreviewSTyle()%>  id="User_With_Token" name="User_With_Token" type="submit"  align="left" value=" <%=appMsg.getString("f.user.with.security.code")%>" class="inputButton inputbuttonm" /> 
                        </div>
