            ...
            <div class="row" >
                ...
                <div class="col-md-3">
                    <div class="col-md-12 dbg">
                        <div id="successpanel">
                            <div id="succ_fail_content">
                                <div class="container-fluid" style="padding-top:1em;" dir="rtl">
                                    <div  id="loginsuccess" class="row" style="display: inline-block; margin: 0 auto; padding-bottom:200px;">
                                        <%=appMsg.getString("info.system.not.available")%>  
                                    </div>
                                </div>
                                </div>
                            </div>  
