                        ...
                        <form name="theform" id="theform" action="<%=controller%>"    method="post"    >
                            ...
                            <div class="login_box">
                                <div class="login_inside_border">
                                    ...
                                    <%}%>
                                    <div class="formlabel" style="display: none"> <%=appMsg.getString("f.country.code")%></div>
                                    ...
                                    <div class="loginfield" style="display: none">
                                        ...
                                        <div class="formlabel" style="padding:10px 15px 10px" dir="rtl"> <%=appMsg.getString("f.auth.code")%></div>
                                    ...
                                    <input id="Enter" name="Enter" type="submit" value="<%=appMsg.getString("f.enter")%>" class="inputButton" style="margin-top:-5px"  />
                                    <input id="Register_New" name="Register_New" type="submit"  align="center" value=" <%=appMsg.getString("f.register.new.account")%>"  style="margin-top:-20px"  class="inputButton"/>
                                </div>
                                <div class="button1" style="display:none;">
                                    <input    id="Existing_User" name="Existing_User" type="submit" align="center" value=" <%=appMsg.getString("f.existing.user.login")%>" class="general-button inputButton"  />
                                </div>
                            </div>
                        </form>
