...
<div class="container-fluid" style="padding-top:10px">
    <div class="row">
        ...
        <div class="col-md-6" style="display: inline-block;">
            ...
            <input name="button1" type="submit" class="txtHeadbtnact bdrr" value="&#1593;&#1585;&#1576;&#1610;" onclick="location.href = '<%=welcomePageAr%>'" />
            <input name="button1" type="submit" class="txtHeadbtn" value="English" onclick="location.href = '<%=welcomePage%>'"/>
        </div>
