            ...
            <div class="row" >
                ...
                <div class="col-md-3">
                    ...
                    <div class="startVerification">
                        ...
                        <div id="loginbox3">
                            <input id="submit" name="submit" type="submit" value=" <%=appMsg.getString("f.verify")%>" class="enter_button inputButton"  />
                    ...
                    <div id="loginpanel2">
                        <div id="loginbox4"  >
                            <input   id="Register_New" name="Register_New" type="submit" value=" <%=appMsg.getString("f.register.new.account")%>" class="enter_button inputButton" style="margin-top:-20px" />
                        </div>
                    </div>
                </form>
                    </div>
