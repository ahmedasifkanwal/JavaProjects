                ...
                <div class="row">
                    ...
                    <div class="col-md-12 slider" id="main-slider1"> <!--outermost container element -->
                        <div class="add-space-1"><!-- innermost wrapper element -->
                            ...
                            <a href="omantel.om" target="_blank"><img class="Bannerimg slide img-fluid img-rounded" src="<%=request.getContextPath()%>/fixedtemplate/Banner1/includes/defaultImage/default_p1_s1_top_ar.png" alt=""></a>
                ...
                <div class="col-md-12 dbg">
                    ...
                    <form name="theform" id="theform" action="<%=controller%>"  method="post" >
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 echrowpad" style="margin-top: 3vh;">
                                <div class="frmTxt"></div> 
                                <input placeholder="Enter Mobile Number*" name="mobileNumber" class="input pass" type="text" id="mobileNumber" maxlength="12" value="<%=mobileNumber%>"/>
                                <%if (errorMap != null) {%>
                                <span class="frmTxt"> 
                            ...
                            <!-- Component 4--> 
                            <div class="col-md-2 echrowpadb" style="margin-top: 3vh;"> 
                                <input  id="User_With_Token" name="User_With_Token" type="submit"  align="left" value=" <%=appMsg.getString("f.user.with.security.code")%>" class="inputButton inputbuttonm" /> 
                            </div>
