...
<%
    ...
    try {
        ...
        if (session.getAttribute("peLogin") != null) {
            ...
            controller = request.getContextPath() + "/fixedtemplate/" + peLogin.OWNERNAME_NOSPACE() + "/controller/LogoutController.jsp?lang=ar";
                                    ...
                                    <div class="login_box">
                                        <div class="login_inside_border">
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="success_txt"  >
                                                ...
                                                <tr> <%= paymentDetailsRow%> </tr>
                                                <tr  >
                                                    <td align="center"  ><%=paymentDetails%></td>
                                                </tr>
                                                <tr class="click_here">
                                                    <td align="center"  ><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:20px; margin-bottom:20px;">
                                                            ...
                                                            <tr>
                                                                <td align="center">ساعات</td>
                                                                <td align="center">دقائق</td>
                                                                <td align="center">ثواني</td>
                                                            </tr>
                                                        </table></td>
                                                </tr>
