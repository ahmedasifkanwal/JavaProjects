...
<%
    ...
    String userName = "", password = "", controller = "",  mobileNumber = "", staffActiveIn = "", visitorActiveIn = "", staffActive = "", visitorActive = "";
    Result result = null;
    Map errorMap = null;
                        ...
                        <div class="col-md-4" id="loginmobile_right" >
                            ...
                            <div class="bs-example bs-example-tabs cstyle04">
                                <ul class="nav nav-tabs" id="myTab">
                                    ...
                                    <li onclick="mySelectUpdate()" class="<%=visitorActive%>"><a data-toggle="tab" href="#tabvisitor"><span class="flight"></span> VISITOR</a></li>
                                <li onclick="mySelectUpdate()" class="<%=staffActive%>"><a data-toggle="tab" href="#tabstaff"><span class="hotel"></span>STAFF</a></li>
                            ...
                            <form name="theform" id="theform" action="<%=controller%>"    method="post"    >
                                ...
                                <div class="tab-content" id="myTabContent">
                                    ...
                                    <div id="tabstaff" class="<%=staffActiveIn%>">
                                        ...
                                        <div class="w100percent">
                                            <div class="wh90percent textleft"> <span class="opensans size13"><b><%=appMsg.getString("f.user.name")%></b></span>
                                        ...
                                        <div class="w100percent">
                                            <div class="wh90percent textleft"> <span class="opensans size13"><b><%=appMsg.getString("f.password")%></b></span>
