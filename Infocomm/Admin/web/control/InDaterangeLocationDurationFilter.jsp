...
<div class="col-sm-2 col-md-3" >
    <div class="console-btn" style=" font-size: 10px; color:#33cccc ;padding: 1px 1px 1px 10px;border-radius:5px;width:90%;margin-left:14px " data-toggle="tooltip" title="" data-original-title="Please Select Date Range." data-placement="bottom">
     ...
     <div class="col-sm-4 col-md-4">
                    ...
                    <div class="col-sm-2 col-md-2">
                        <div class="console-btn" style=" font-size: 10px; color:#33cccc ;padding: 1px 1px 1px 1px;border-radius:5px;width:80% " data-toggle="tooltip" title="" data-original-title="Please Select Filter" data-placement="bottom">
                            <div class="console-icon divider-right" >
                                <span class="glyphicons glyphicons-filter" ></span> </div>
                            <div class="console-text">
                                <div class="console-subtitle pull-right">
                                <s:select  cssStyle="width:100px"      cssClass="form-control"  id="durationType" name="durationType" list="peDurationFilterList" listKey="durationType" listValue="displayValue"  ></s:select>
                            </div>
                        </div>
                    </div>
                </div>
