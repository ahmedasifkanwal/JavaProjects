        ...
        <div class="col-md-12">
            <div class="panel">
                <div class="panel-heading">
                    ...
                    <input type="checkbox" checked id="movedashboard" class="pull-right" title="Check to move dashboard" value="">
                </div>
                <s:form action="dashboard.icms"  theme="simple"   >
                    ...
                    <%
                        ...
                        if (list != null) {
                            for (SysAction p : list) {
                                if (p.getActionName().equals("dashboard.icms")) {
                                    isDash = true;
                                    break;
                                }
                            }
                    ...
                    <div class="container" id="saleem" >
                        <%if (isDash) {%>
                        <jsp:include page="../include/ProfileStatictics_Row1.jsp" ></jsp:include>
                        <%if (true) {%>

                        <jsp:include page="../include/ProfileStatictics_Row2.jsp" ></jsp:include>
                        <jsp:include page="../include/ProfileStatictics_Row3.jsp" ></jsp:include>
                        <jsp:include page="../include/DynamicWelcomeCharts.jsp" ></jsp:include>
                        <jsp:include page="../include/LiStatistics_Row4.jsp" ></jsp:include>
                        <jsp:include page="../include/LiStatistics_Row5.jsp" ></jsp:include>
                        <jsp:include page="../control/LocationMap.jsp" ></jsp:include>
