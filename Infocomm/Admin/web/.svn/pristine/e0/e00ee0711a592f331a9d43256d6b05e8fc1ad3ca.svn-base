            ...
            <div class="col-sm-2 col-md-2">
                <div class="console-btn" style=" font-size: 10px; color:#33cccc ;padding: 1px 1px 1px 1px;border-radius:5px;width:90% " data-toggle="tooltip" title="" data-original-title="Please Enter Mobile No." data-placement="bottom">
                            ...
                            <div class="console-text">
                                ...
                                <div class="col-sm-2 col-md-2">
                                    <div class="console-btn" style=" font-size: 10px; color:#33cccc ;padding: 1px 1px 1px 1px;border-radius:5px;width:90% " data-toggle="tooltip" title="" data-original-title="Please Enter IMSI." data-placement="bottom">
                    <div class="console-icon divider-right" >
                        <span class="glyphicons glyphicons-classic_hammer" ></span> </div>
                    <div class="console-text">
                        <div class="console-subtitle pull-right" id="html_vlanlist">
                            <s:textfield id="imsi"   cssClass="form-control margin-top-none"  name="imsi"/>
                        </div>
                    </div>
                </div>
            </div>
