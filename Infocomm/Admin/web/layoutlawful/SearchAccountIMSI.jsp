...
<div class="container">
            ...
            <div class="panel">
                <div class="panel-heading">
                    ...
                    <div class="form-group pull-right">
                        ...
                        <s:form action="searchaccountimsi.icms"  theme="simple"   >
                    ...
                    <div class="container"  >
                        <div class="row" style="margin-top: 5px ">
                            ...
                            <jsp:include page="../control/InMacUserMobileIMSI.jsp"></jsp:include>
                                    ...
                                    (function ($) {
                                        $(function () {
                                            $("#refresh").click(function ()
                                            {
                                                ...
                                                var data =
                                                        {
                                                            'reportId': 'RPT_WIFI_USER_ACCOUNT_IMSI',
                                                          ...
                                                          )
                                                  {
                                                      ...
                                                      alert('Please enter at least one input parameter.');
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="panel">
                <div class="panel-heading">
                    <div class="panel-title"> <span class="glyphicon glyphicon-list-alt"></span> WiFi User </div>
                </div>
                <div class="panel-body">
