...
<div class="container">
                ...
                <s:form action="datautilization.icms"  theme="simple"   >
                    ...
                    <div class="container"  >
                        <div class="row" style="margin-top: 5px ">
                            ...
                            <jsp:include page="../control/InDaterangeLocationCriteria.jsp"></jsp:include>
                        </div>
                                            ...
                                            (function ($) {
                                                $(function () {
...

                                                    {
                                                        ...
                                                        $.ajax({
                                                            type: "POST",
                                                            url: "json/JsonSMSStatistics.jsp?data=" + JSON.stringify(data),
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="panel">
                <div class="panel-heading">
                    <div class="panel-title"> <span class="glyphicon glyphicon-list-alt"></span> SMS Delivery </div>
                </div>
                <div class="panel-body">
