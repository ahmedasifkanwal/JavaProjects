...
(function(b) {
    ...
    r.funnel = b.extendClass(r.pie, {type: "funnel", animate: E, translate: function() {
            var a = function(i, a) {
            ...
            for (this.center[2] -= 2 * b; j--; )
                o = a[j], c = (e = o.half) ? 1 : -1, n = o.plotY, f = this.getX(n, e), o.labelPos = [0, n, f + (b - 5) * c, n, f + b * c, n, e ? "right" : "left", 0];
