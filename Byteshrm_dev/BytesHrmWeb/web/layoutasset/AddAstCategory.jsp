                    ...
                    <div class="page-content">
                        ...
                        <div class="portlet box blue ">
                            ...
                            <div class="portlet-body">
                                <s:form  id="addastCategory" name="addastCategory"  action="aAstCategory.itb"   cssClass="login-form" method="post" theme="simple" enctype="multipart/form-data" novalidate="novalidate"  >
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-actions">
                                                 ...
                                                 <a href="oAstCategory.itb" data-toggle="confirmation" data-original-title="Are you sure ?" class="btn blue btn-outline">
