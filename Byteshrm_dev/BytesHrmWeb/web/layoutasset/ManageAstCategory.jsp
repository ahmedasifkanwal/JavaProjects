                    ...
                    <div class="page-content">
                        <div class="portlet box blue">
                            <div class="portlet-title">
                                ...
                                <div class="actions">
                                    <a href="oAstCategory.itb"   class="btn btn-default btn-sm">
                                        <i class="fa fa-plus"></i> Add Category </a>
                                </div>
                            </div>
                            <div class="portlet-body form">
                                <!-- BEGIN FORM-->
                                <s:form action="mAstCategory.itb" cssClass="horizontal-form" method="post" theme="simple" id="form_sample_2"  novalidate="novalidate">
                                                ...
                                                <div class="portlet light portlet-fit portlet-datatable bordered">
                                                    <div class="portlet-body">
                                                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                                            ...
                                                            <tbody>
                                                                <s:iterator var="p"  status="rowStatus"  value="astCategoryDto.astCategoryList">
                                                                    <tr class="gradeX">
                                                                        ...
                                                                        <td>
                                                                            <a href="gAstCategory.itb?id=<s:property value="%{id}" />" class="btn btn-outline btn-circle green btn-sm blue-stripe">
