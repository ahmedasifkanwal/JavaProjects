                    ...
                    <div class="page-content">
                        ...
                        <div class="portlet box blue ">
                            ...
                            <div class="portlet-body">
                                <s:form  id="addastVendor" name="addastVendor"  action="aAstVendor.itb"   cssClass="login-form" method="post" theme="simple" enctype="multipart/form-data" novalidate="novalidate"  >
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-actions">
                                                 ...
                                                 <a href="oAstVendor.itb" data-toggle="confirmation" data-original-title="Are you sure ?" class="btn blue btn-outline">
