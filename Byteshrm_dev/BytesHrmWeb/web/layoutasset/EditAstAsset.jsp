                    ...
                    <div class="page-content">
                        ...
                        <div class="portlet box blue ">
                            ...
                            <div class="portlet-body">
                                <s:form  id="eAstVendor" name="eAstVendor"  action="eAstVendor.itb"   cssClass="login-form" method="post" theme="simple" enctype="multipart/form-data" novalidate="novalidate"  >

                                    <s:hidden name="astVendor.id" id="id"></s:hidden>
                                    <div class="row">
                                    ...
                                    <div class="form-body">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <s:textfield cssClass="form-control"  autocomplete="off"  
                                                                 name="astVendor.name" id="name"   /> 
                                                    <span> <s:fielderror   fieldName="astVendor"/></span>
                                                </div>
                                            </div>
                                        </div>    
                                        ...
                                        <div class="row"> 
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <s:textfield cssClass="form-control"  autocomplete="off"  
                                                                 name="astVendor.contactNo" id="contactNo"   /> 
                                        ...
                                        <div class="row"> 
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <s:textfield cssClass="form-control"  autocomplete="off"  
                                                                 name="astVendor.website" id="website"   /> 
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <s:textfield cssClass="form-control"  autocomplete="off"  
                                                                 name="astVendor.address" id="address"   /> 
                                        ...
                                        <div class="form-actions">
                                            <a href="mAstVendor.itb" data-toggle="confirmation" data-original-title="Are you sure ?" class="btn red btn-outline">
                                                <i class="fa fa-remove"></i> Cancel </a>
                                            <a href="gAstVendor.itb?id=<s:property value="%{astVendor.id}" />" data-toggle="confirmation" data-original-title="Are you sure ?" class="btn blue btn-outline">
