                    ...
                    <div class="page-content">
                        ...
                        <div class="portlet box blue ">
                            ...
                            <div class="portlet-body">
                                <s:form  id="eAstCategory" name="eAstCategory"  action="eAstCategory.itb"   cssClass="login-form" method="post" theme="simple" enctype="multipart/form-data" novalidate="novalidate"  >

                                    <s:hidden name="astCategory.id" id="id"></s:hidden>
                                    <div class="row">
                                    ...
                                    <div class="form-body">
                                        <div class="row"> 
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <s:textfield cssClass="form-control"  autocomplete="off"  size="45"
                                                                 name="astCategory.name" id="name"   /> 
                                                    <span> <s:fielderror   fieldName="astCategory"/></span>
                                                </div>
                                            </div>
                                        </div>    
                                        ...
                                        <div class="form-actions">
                                            <a href="mAstCategory.itb" data-toggle="confirmation" data-original-title="Are you sure ?" class="btn red btn-outline">
                                                <i class="fa fa-remove"></i> Cancel </a>
                                            <a href="gAstCategory.itb?id=<s:property value="%{astCategory.id}" />" data-toggle="confirmation" data-original-title="Are you sure ?" class="btn blue btn-outline">
