                    ...
                    <div class="page-content">
                        ...
                        <div class="portlet box blue ">
                            ...
                            <div class="portlet-body">
                                <s:form  id="eAstBrand" name="eAstBrand"  action="eAstBrand.itb"   cssClass="login-form" method="post" theme="simple" enctype="multipart/form-data" novalidate="novalidate"  >

                                    <s:hidden name="astBrand.id" id="id"></s:hidden>
                                    <div class="row">
                                    ...
                                    <div class="form-body">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <s:textfield cssClass="form-control"  autocomplete="off" size="45"  
                                                                 name="astBrand.name" id="name"   /> 
                                                    <span> <s:fielderror   fieldName="astBrand"/></span>
                                                </div>
                                            </div>
                                        </div>    
                                        ...
                                        <div class="form-actions">
                                            <a href="mAstBrand.itb" data-toggle="confirmation" data-original-title="Are you sure ?" class="btn red btn-outline">
                                                <i class="fa fa-remove"></i> Cancel </a>
                                            <a href="gAstBrand.itb?id=<s:property value="%{astBrand.id}" />" data-toggle="confirmation" data-original-title="Are you sure ?" class="btn blue btn-outline">
