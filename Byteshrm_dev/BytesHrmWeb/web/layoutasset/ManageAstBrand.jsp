                    ...
                    <div class="page-content">
                        <div class="portlet box blue">
                            <div class="portlet-title">
                                ...
                                <div class="actions">
                                    <a href="oAstBrand.itb"   class="btn btn-default btn-sm">
                                        <i class="fa fa-plus"></i> Add Brand </a>
                                </div>
                            </div>
                            <div class="portlet-body form">
                                <!-- BEGIN FORM-->
                                <s:form action="mAstBrand.itb" cssClass="horizontal-form" method="post" theme="simple" id="form_sample_2"  novalidate="novalidate">
                                                ...
                                                <div class="portlet light portlet-fit portlet-datatable bordered">
                                                    <div class="portlet-body">
                                                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                                            ...
                                                            <tbody>
                                                                <s:iterator var="p"  status="rowStatus"  value="astBrandDto.astBrandList">
                                                                    <tr class="gradeX">
                                                                        ...
                                                                        <td>
                                                                            <a href="gAstBrand.itb?id=<s:property value="%{id}" />" class="btn btn-outline btn-circle green btn-sm blue-stripe">
