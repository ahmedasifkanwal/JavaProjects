                    ...
                    <div class="page-content">
                        ...
                        <div class="portlet box blue ">
                            ...
                            <div class="portlet-body">
                                <s:form  id="addempTerminationReason" name="addempTerminationReason"  action="aEmpTerminationReason.itb"   cssClass="login-form" method="post" theme="simple" enctype="multipart/form-data" novalidate="novalidate"  >
                                    ...
                                    <div class="form-body">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <s:textfield cssClass="form-control"  autocomplete="off"  
                                                                 name="empTerminationReason.name" id="termination_reason_name"   /> 
                                                    <span> <s:fielderror   fieldName="termination_reason_name"/></span>
                                        ...
                                        <div class="form-actions">
                                            <a href="mEmpTerminationReason.itb" class="btn red btn-outline" data-toggle="confirmation" data-original-title="Are you sure ?">
                                                <i class="fa fa-mail-reply"></i> Cancel </a>
                                            <a href="oEmpTerminationReason.itb" class="btn blue btn-outline"data-toggle="confirmation" data-original-title="Are you sure ?">
