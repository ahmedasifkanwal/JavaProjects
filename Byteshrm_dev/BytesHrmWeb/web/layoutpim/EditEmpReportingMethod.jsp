                    ...
                    <div class="page-content">
                        ...
                        <div class="portlet box blue ">
                            ...
                            <div class="portlet-body">
                                <s:form  id="eEmpReportingMethod" name="eEmpReportingMethod"  action="eEmpReportingMethod.itb"   cssClass="login-form" method="post" theme="simple" enctype="multipart/form-data" novalidate="novalidate"  >
 
                                    <s:hidden name="empReportingMethod.reportingMethodId" id="reportingMethodId"></s:hidden>
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <s:textfield cssClass="form-control"  autocomplete="off"  
                                                         name="empReportingMethod.reportingMethodName" id="empReportingMethod"   /> 
                                            <span> <s:fielderror   fieldName="empReportingMethod"/></span>

                                        </div>


                                        <div class="form-actions">
                                            <a href="mEmpReportingMethod.itb" data-toggle="confirmation" data-original-title="Are you sure ?" class="btn red btn-outline">
                                                <i class="fa fa-remove"></i> Cancel </a>
                                            <a href="gEmpReportingMethod.itb?id=<s:property value="%{empReportingMethod.reportingMethodId}" />" data-toggle="confirmation" data-original-title="Are you sure ?" class="btn blue btn-outline">
