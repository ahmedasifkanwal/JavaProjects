                    ...
                    <div class="page-content">
                        ...
                        <div class="portlet box blue ">
                            ...
                            <div class="portlet-body">
                                <s:form  id="addempReportingMethod" name="addempReportingMethod"  action="aEmpReportingMethod.itb"   cssClass="login-form" method="post" theme="simple" enctype="multipart/form-data" novalidate="novalidate"  >
                                    ...
                                    <div class="form-body">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <s:textfield cssClass="form-control"  autocomplete="off"  
                                                                 name="empReportingMethod.reportingMethodName" id="reporting_method_name"   /> 
                                                    <span> <s:fielderror   fieldName="reporting_method_name"/></span>
                                        ...
                                        <div class="form-actions">
                                            <a href="mEmpReportingMethod.itb" class="btn red btn-outline" data-toggle="confirmation" data-original-title="Are you sure ?" >
                                                <i class="fa fa-mail-reply"></i> Cancel </a>
                                            <a href="oEmpReportingMethod.itb" class="btn blue btn-outline" data-toggle="confirmation" data-original-title="Are you sure ?" >
