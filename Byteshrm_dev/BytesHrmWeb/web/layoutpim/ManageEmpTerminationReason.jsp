                        ...
                        <div class="portlet box blue">
                            <div class="portlet-title">
                                ...
                                <div class="tools">
                                 ...
                                 <div class="actions">
                                    <a href="oEmpTerminationReason.itb"   class="btn btn-default btn-sm">
                                        <i class="fa fa-plus"></i> Add Termination Reason </a>
                                </div>
                            </div>
                            <div class="portlet-body form">
                                <!-- BEGIN FORM-->
                                <s:form action="mEmpTerminationReason.itb" cssClass="horizontal-form" method="post" theme="simple" id="form_sample_2"  novalidate="novalidate">
                                                ...
                                                <div class="portlet light portlet-fit portlet-datatable bordered">
                                                        ...
                                                        <div class="actions">
                                                            ...
                                                            <div class="btn-group">
                                                                <a class="btn blue-dark btn-outline btn-circle" href="#" data-toggle="dropdown">
                                                                    ...
                                                                    <span class="hidden-xs"> Reporting Method</span>
                                                                ...
                                                                <ul class="dropdown-menu pull-right" id="datatable_ajax_tools">
                                                                    ...
                                                                    <li>
                                                                        <a  class="action" href="oEmpTerminationReason.itb">
                                                                            <i class="icon-plus"></i>Add Reporting Method </a>
                                                                    </li>
                                                    ...
                                                    <div class="portlet-body">
                                                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                                            ...
                                                            <tbody>
                                                                <s:iterator var="p" status="rowCount" value="empTerminationReasonDto.empTerminationReasonList">
                                                                    <tr class="odd gradeX">
                                                                        <td>
                                                                        ...
                                                                        <td>
                                                                            <a href="gEmpTerminationReason.itb?empTerminationReason.id=<s:property value="%{id}" />" class="btn btn-outline btn-circle green btn-sm blue-stripe">
