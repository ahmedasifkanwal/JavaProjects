                    ...
                    <div class="page-content">
                        ...
                        <div class="portlet box blue ">
                            ...
                            <div class="portlet-body">
                                <s:form   id="aNationalities" name="aNationalities"   action="aNationalities.itb"   cssClass="login-form" method="post" theme="simple" novalidate="novalidate"  >
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <a href="mNationalities.itb? />" class="btn red btn-outline">
                                                <i class="fa fa-mail-reply"></i> Cancel </a>
                                            <a href="oNationalities.itb? />" class="btn blue btn-outline">
                                                <i class="fa fa-remove"></i> Clear </a>

                                            <s:submit   method="save"  cssClass="btn green btn-outline"   id="save" key="btn.save" />
                                        </div>
