                    ...
                    <div class="page-content">
                        ...
                        <div class="portlet box blue ">
                            ...
                            <div class="portlet-body">
                                <s:form  id="editnationalities" name="editnationalities"  action="eNationalities.itb"   cssClass="login-form" method="post" theme="simple" enctype="multipart/form-data" novalidate="novalidate"  >

                                    <s:hidden name="nationality.id" id="nationality.id"></s:hidden>
                                        <div class="row">
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-actions">
                                            <s:submit cssClass="btn blue"   id="cancel" key="Cancel" />
                                            <s:submit   method="edit"  cssClass="btn blue"   id="save" key="btn.save" />
                                        </div>
                                        <div class="form-actions">
                                            <a href="mNationalities.itb?id" class="btn red btn-outline">
                                                <i class="fa fa-remove"></i> Cancel </a>
                                            <a href="gNationalities.itb?id=<s:property value="%{nationality.id}" />" class="btn blue btn-outline">
                                                <i class="fa fa-remove"></i> Reset </a>
                                                <s:submit   method="edit"  cssClass="btn green btn-outline"   id="save" key="btn.save" />
                                        </div>
