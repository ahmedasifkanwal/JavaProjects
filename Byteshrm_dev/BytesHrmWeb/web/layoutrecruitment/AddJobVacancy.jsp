            ...
            <div class="page-container">
                ...
                <div class="page-content-wrapper">
                    ...
                    <div class="page-content">
                        ...
                        <s:form  id="aJobVacancy" name="aJobVacancy"  action="aJobVacancy.itb"   cssClass="form-horizontal" method="post" theme="simple" novalidate="novalidate"  >
                                                    ...
                                                    <div class="portlet-body form">
                                                        <div class="form-body">
                                                            ...
                                                            <div class="form-action">
                                                                ...
                                                                <a href="oJobVacancy.itb" class="btn blue btn-outline" data-toggle="confirmation" data-original-title="Are you sure ?" >
                                                                    <i class="fa fa-remove"></i> Clear </a>
                                                                <s:submit  method="save"  cssClass="btn green btn-outline" data-toggle="confirmation" data-original-title="Are you sure ?" id="save" key="btn.save" />
                                                            </div>
                                                            <!-- END FORM-->  
                                                        </div>
                                                    </div>
