                    ...
                    <div class="page-content">
                        ...
                        <div class="portlet box blue ">
                            ...
                            <div class="portlet-body">
                                <s:form  id="eLicense" name="eLicense"  action="eLicense.itb"   cssClass="login-form" method="post" theme="simple" novalidate="novalidate"  >

                                      <s:hidden name="license.id" id="license.id"></s:hidden>
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="control-label">License Name
                                            ...
                                            <a href="mLicense.itb" class="btn red btn-outline" data-toggle="confirmation" data-original-title="Are you sure ?" >
                                                <i class="fa fa-remove"></i> Cancel </a>
                                            <a href="gLicense.itb?id=<s:property value="%{license.id}" />" class="btn blue btn-outline" data-toggle="confirmation" data-original-title="Are you sure ?" >
