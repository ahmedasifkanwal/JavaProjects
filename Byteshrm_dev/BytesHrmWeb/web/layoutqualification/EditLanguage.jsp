                    ...
                    <div class="page-content">
                        ...
                        <div class="portlet box blue ">
                            ...
                            <div class="portlet-body">
                                <s:form  id="eLanguage" name="eLanguage"  action="eLanguage.itb"   cssClass="login-form" method="post" theme="simple" novalidate="novalidate"  >

                                      <s:hidden name="language.id" id="language.id"></s:hidden>
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <a href="gLanguage.itb?id=<s:property value="%{language.id}" />" class="btn blue btn-outline" data-toggle="confirmation" data-original-title="Are you sure ?">
