                    ...
                    <div class="page-content">
                        ...
                        <div class="portlet box blue ">
                            ...
                            <div class="portlet-body">
                                <s:form  id="eEducation" name="eEducation"  action="eEducation.itb"   cssClass="login-form" method="post" theme="simple" novalidate="novalidate"  >

                                      <s:hidden name="education.id" id="education.id"></s:hidden>
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <a href="mEducation.itb" class="btn red btn-outline" data-toggle="confirmation" data-original-title="Are you sure ?" >
                                                <i class="fa fa-remove"></i> Cancel </a>
                                            <a href="gEducation.itb?id=<s:property value="%{education.id}" />" class="btn blue btn-outline" data-toggle="confirmation" data-original-title="Are you sure ?" >
