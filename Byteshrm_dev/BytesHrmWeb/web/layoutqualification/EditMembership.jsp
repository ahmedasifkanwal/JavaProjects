                    ...
                    <div class="page-content">
                        ...
                        <div class="portlet box blue ">
                            ...
                            <div class="portlet-body">
                                <s:form  id="eMembership" name="eMembership"  action="eMembership.itb"   cssClass="login-form" method="post" theme="simple" novalidate="novalidate"  >

                                      <s:hidden name="membership.id" id="membership.id"></s:hidden>
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="control-label">Membership Name
                                            ...
                                            <a href="mMembership.itb" class="btn red btn-outline" data-toggle="confirmation" data-original-title="Are you sure ?" >
                                                <i class="fa fa-remove"></i> Cancel </a>
                                            <a href="gMembership.itb?id=<s:property value="%{membership.id}" />" class="btn blue btn-outline" data-toggle="confirmation" data-original-title="Are you sure ?" >
