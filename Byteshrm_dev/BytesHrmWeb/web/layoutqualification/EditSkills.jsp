                    ...
                    <div class="page-content">
                        ...
                        <div class="portlet box blue ">
                            ...
                            <div class="portlet-body">
                                <s:form  id="eSkills" name="eSkills"  action="eSkills.itb"   cssClass="login-form" method="post" theme="simple"  novalidate="novalidate"  >


                                    <s:hidden name="skill.id" id="skill.id"></s:hidden>
                                        <div class="row">
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="control-label">Skill Name
                                        ...
                                        <div class="form-group">
                                            ...
                                            <s:textarea  autocomplete="off"   name="skill.description"   id="mt-clipboard-paste" cssClass="form-control" rows="3"></s:textarea>
                                            ...
                                            <a href="mSkills.itb" class="btn red btn-outline" data-toggle="confirmation" data-original-title="Are you sure ?" >
                                                <i class="fa fa-remove"></i> Cancel </a>
                                            <a href="gSkills.itb?id=<s:property value="%{skill.id}" />" class="btn blue btn-outline" data-toggle="confirmation" data-original-title="Are you sure ?" >
