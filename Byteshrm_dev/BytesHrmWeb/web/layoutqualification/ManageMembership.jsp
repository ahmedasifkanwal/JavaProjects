                        ...
                        <div class="portlet box blue">
                            <div class="portlet-title">
                                ...
                                <div class="tools">
                                 ...
                                 <div class="actions">
                                    <a href="oMembership.itb"   class="btn btn-default btn-sm">
                                        <i class="fa fa-plus"></i> Add Membership </a>
                                </div>
                            </div>
                            <div class="portlet-body form">
                                <!-- BEGIN FORM-->
                                <s:form action="mMembership.itb" cssClass="horizontal-form" method="post" theme="simple" id="form_sample_2"  novalidate="novalidate">
                                                ...
                                                <div class="portlet light portlet-fit portlet-datatable bordered">
                                                    ...
                                                    <div class="portlet-body">
                                                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                                            ...
                                                            <tbody>
                                                                <s:iterator var="p" value="membershipDto.membershipList">
                                                                    <tr class="odd gradeX">
                                                                        <td>
                                                                            <s:property value="%{id}" />
                                                                        </td>
                                                                        ...
                                                                        <td>
                                                                            <a href="gMembership.itb?id=<s:property value="%{id}" />" class="btn btn-outline btn-circle green btn-sm blue-stripe">
