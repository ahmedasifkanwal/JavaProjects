                    ...
                    <div class="page-content">
                        ...
                        <div class="portlet box blue ">
                            ...
                            <div class="portlet-body">
                                <s:form  id="aSkills" name="aSkills"  action="aSkills.itb"   cssClass="login-form" method="post" theme="simple" enctype="multipart/form-data" novalidate="novalidate"  >
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-actions">
                                            ...
                                            <a href="oSkills.itb" class="btn blue btn-outline" data-toggle="confirmation" data-original-title="Are you sure ?" >
