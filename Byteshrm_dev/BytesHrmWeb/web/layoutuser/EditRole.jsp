...
<html lang="en">
                                ...
                                <s:form  id="form1" name="form1"  action="erole.itb"   cssClass="login-form" method="post" theme="simple" enctype="multipart/form-data" novalidate="novalidate"  >
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <s:textfield cssClass="form-control"  autocomplete="off"  
                                                          name="sysAuthoritiesDto.sysAuthoritiesVo.title" id="title"    />
  ...
  <span >  <s:fielderror   fieldName="title" /> </span>
                                        ...
                                        <div class="form-actions">
                                            ...
                                            <a href="grole.itb?id=<s:property value="%{sysAuthoritiesDto.sysAuthoritiesVo.id}" />" class="btn blue btn-outline" data-toggle="confirmation" data-original-title="Are you sure ?" >
