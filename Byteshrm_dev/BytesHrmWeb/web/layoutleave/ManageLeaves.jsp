                        ...
                        <div class="portlet box blue">
                            <div class="portlet-title">
                                ...
                                <div class="tools">
                                 ...
                                 <div class="actions">
                                    <a href="oLeaves.itb"   class="btn btn-default btn-sm">
                                        <i class="fa fa-plus"></i> Add Leave </a>
                                </div>
                            </div>
                            <div class="portlet-body form">
                                <!-- BEGIN FORM-->
                                <s:form  action="mLeaves.itb" cssClass="horizontal-form" method="post" theme="simple" id="form_sample_2"  novalidate="novalidate">
                                                ...
                                                <div class="portlet light portlet-fit portlet-datatable bordered">
                                                    ...
                                                    <div class="portlet-body">
                                                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                                            ...
                                                            <tbody>
                                                                <s:iterator var="p" status="rowCount" value="leavesDto.leavesList">
                                                                    <tr class="odd gradeX">
                                                                        <td>
                                                                        ...
                                                                        <td>
                                                                            <s:property value="%{empNumber.empFirstname}" />
                                                                        </td>
                                                                        <td>
                                                                            <s:property value="%{leaveTypeId.name}" />
                                                                        </td>
                                                                        <td>
                                                                            <s:property value="%{lengthDays}" />
                                                                        </td>
                                                                        <td>
                                                                            <s:property value="%{lengthDays}" />
                                                                        </td>
                                                                        ...
                                                                        <td>
                                                                            <a href="gLeaves.itb?leaves.id=<s:property value="%{id}" />" class="btn btn-outline btn-circle green btn-sm blue-stripe">
