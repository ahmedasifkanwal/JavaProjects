                    ...
                    <div class="page-content">
                        <div class="portlet box blue">
                            <div class="portlet-title">
                                ...
                                <div class="actions">
                                    <a href="oLeaveType.itb"   class="btn btn-default btn-sm">
                                        <i class="fa fa-plus"></i> Add Leave Type </a>
                                </div>
                            </div>
                            <div class="portlet-body form">
                                <!-- BEGIN FORM-->
                                <s:form action="mLeaveType.itb" cssClass="horizontal-form" method="post" theme="simple" id="form_sample_2"  novalidate="novalidate">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th> Is Entitlement Situational ?</th>
                                                                    <th> Action</th>

                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                                <s:iterator var="p"  status="rowStatus"  value="leaveTypeDto.leaveTypeList">
                                                                    <tr class="gradeX">
                                                                       ...
                                                                       <span class="label label-sm label-success"> <s:property value="%{excludeInReportsIfNoEntitlement}" /></span>
                                                                        ...
                                                                        <td>
                                                                            <a href="gLeaveType.itb?id=<s:property value="%{id}" />" class="btn btn-outline btn-circle green btn-sm blue-stripe">
