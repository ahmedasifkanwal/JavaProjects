                    ...
                    <div class="page-content">
                        ...
                        <div class="portlet box blue ">
                            ...
                            <div class="portlet-body">
                                <s:form  id="addleaveType" name="addleaveType"  action="aLeaveType.itb"   cssClass="login-form" method="post" theme="simple" enctype="multipart/form-data" novalidate="novalidate"  >
                                        ...
                                        <div class="row"> 
                                            ...
                                            <div class="col-md-6"> 
                                                <div class="form-group">
                                                    ...
                                                    <s:checkbox autocomplete="off" cssClass="form-check-input" name="leaveType.excludeInReportsIfNoEntitlement" id="excludeInReportsIfNoEntitlement.id"  > 
                                                    </s:checkbox>
                                   ...
                                   <div class="form-actions">
                                            ...
                                            <a href="oLeaveType.itb" data-toggle="confirmation" data-original-title="Are you sure ?" class="btn blue btn-outline">
