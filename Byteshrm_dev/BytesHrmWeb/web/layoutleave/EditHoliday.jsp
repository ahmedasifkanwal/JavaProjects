                    ...
                    <div class="page-content">
                        ...
                        <div class="portlet box blue ">
                            ...
                            <div class="portlet-body">
                                <s:form  id="eHoliday" name="eHoliday"  action="eHoliday.itb"   cssClass="login-form" method="post" theme="simple" enctype="multipart/form-data" novalidate="novalidate"  >

                                    <s:hidden name="holiday.id" id="id"></s:hidden>
                                    <div class="row">
                                    ...
                                    <div class="form-body">
                                            ...
                                            <div class="row"> 
                                                ...
                                                <div class="col-md-6"> 
                                                    <div class="form-group">
                                                        ...
                                                        <span>  <s:fielderror   fieldName="date"/></span>
                                                    </div>
                                                </div>
                                            </div>   
                                            <div class="form-group">            
                                        ...
                                        <div class="form-actions">
                                            ...
                                            <a href="gHoliday.itb?id=<s:property value="%{holiday.id}" />" data-toggle="confirmation" data-original-title="Are you sure ?" class="btn blue btn-outline">
