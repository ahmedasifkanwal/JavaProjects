                    ...
                    <div class="page-content">
                        ...
                        <div class="portlet box blue ">
                            ...
                            <div class="portlet-body">
                                <s:form  id="addworkWeek" name="addworkWeek"  action="aWorkWeek.itb"   cssClass="login-form" method="post" theme="simple" enctype="multipart/form-data" novalidate="novalidate"  >
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-actions">
                                                ...
                                                <a href="oWorkWeek.itb" data-toggle="confirmation" data-original-title="Are you sure ?" class="btn blue btn-outline">
