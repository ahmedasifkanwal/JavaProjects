            ...
            <div class="page-container">
                ...
                <div class="page-content-wrapper">
                    ...
                    <div class="page-content">
                        ...
                        <s:form  id="aLeaveEntitlement" name="aLeaveEntitlement"  action="aLeaveEntitlement.itb"   cssClass="form-horizontal" method="post" theme="simple" novalidate="novalidate"  >
                                                    ...
                                                    <div class="portlet-body form">
                                                        <div class="form-body">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <div class="col-md-4">
                                                                            <label class="control-label col-md-12">Employee ID<span class="required" aria-required="true"> * </span></label>
                                                                        </div>
                                                            ...
                                                            <div class="form-actions">
                                                                ...
                                                                <a href="oLeaveEntitlement.itb" data-toggle="confirmation" data-original-title="Are you sure ?" class="btn blue btn-outline">
