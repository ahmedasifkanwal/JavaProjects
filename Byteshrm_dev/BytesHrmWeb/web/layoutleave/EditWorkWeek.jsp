                    ...
                    <div class="page-content">
                        ...
                        <div class="portlet box blue ">
                            ...
                            <div class="portlet-body">
                                <s:form  id="eWorkWeek" name="eWorkWeek"  action="eWorkWeek.itb"   cssClass="login-form" method="post" theme="simple" enctype="multipart/form-data" novalidate="novalidate"  >

                                    <s:hidden name="workWeek.id" id="id"></s:hidden>
                                        ...
                                        <div class="form-body">
                                                ...
                                                <div class="col-md-12">
                                                    <label class="control-label">Operational Country
                                                     ...
                                                     <s:select cssClass="bs-select form-control" 
                                                                   ...
                                                                   data-size="8"  
                                                                   name="workWeek.operationalCountryId.id"  
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="control-label">Sunday
                                                            <span class="required" aria-required="true"> * </span>
                                                        </label>
                                                        <s:select cssClass="bs-select form-control"  accesskey=""
                                                                   data-live-search="true" 
                                                                   data-size="8"  
                                                                   name="workWeek.sun"  
                                                                   id="dayLengthList.id"  
                                                                   list="refDto.dayLengthList"
                                                                   headerValue="Non-Working Day"
                                                                   headerKey="0" 
                                                                   listKey="lengthHours" 
                                                ...
                                                <div class="col-md-6">   
                                                    <div class="form-group">
                                                        <label class="control-label">Monday
                                                            <span class="required" aria-required="true"> * </span>
                                                        </label>
                                                        <s:select cssClass="bs-select form-control" 
                                                                  data-live-search="true" 
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="control-label">Tuesday
                                                            <span class="required" aria-required="true"> * </span>
                                                        </label>
                                                        <s:select cssClass="bs-select form-control" 
                                                                  data-live-search="true" 
                                                                  ...
                                                                  headerKey="0"
                                                                  listKey="lengthHours" 
                                                                  listValue="holiddayLength"></s:select>
                                                    </div>
                                                </div>

                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="control-label">Wednesday
                                                            <span class="required" aria-required="true"> * </span>
                                                        </label>
                                                        <s:select cssClass="bs-select form-control" 
                                                                  data-live-search="true" 
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="control-label">Thursday
                                                            <span class="required" aria-required="true"> * </span>
                                                        </label>
                                                        <s:select cssClass="bs-select form-control" 
                                                                  data-live-search="true" 
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="control-label">Friday
                                                            <span class="required" aria-required="true"> * </span>
                                                        </label>
                                                        <s:select cssClass="bs-select form-control" 
                                                                  data-live-search="true" 
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="control-label">Saturday
                                                            <span class="required" aria-required="true"> * </span>
                                                        </label>
                                                        <s:select cssClass="bs-select form-control" 
                                                                  data-live-search="true" 
                                            ...
                                            <div class="form-actions">
                                                <a href="mWorkWeek.itb" data-toggle="confirmation" data-original-title="Are you sure ?" class="btn red btn-outline">
                                                    <i class="fa fa-remove"></i> Cancel </a>
                                                <a href="gWorkWeek.itb?id=<s:property value="%{workWeek.id}" />" data-toggle="confirmation" data-original-title="Are you sure ?" class="btn blue btn-outline">
