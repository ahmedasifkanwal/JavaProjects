            ...
            <div class="page-container">
                ...
                <div class="page-content-wrapper">
                    ...
                    <div class="page-content">
                        ...
                        <jsp:include page="../layout/_inc_breadcrum.jsp"/>
                        ...
                        <div class="portlet box blue ">
                            ...
                            <div class="portlet-body">
                                <s:form  id="eLocation" name="eLocation"  action="eLocation.itb"   cssClass="login-form" method="post" theme="simple" novalidate="novalidate"  >
                                    ...
                                    <div class="form-body">
                                       <div class="form-group">
                                        ...
                                        <div class="form-actions">
                                            <a href="mLocation.itb" data-toggle="confirmation" data-original-title="Are you sure ?" class="btn red btn-outline">
                                                <i class="fa fa-remove"></i> Cancel </a>
                                            <a href="gLocation.itb?id=<s:property value="%{location.id}" />" data-toggle="confirmation" data-original-title="Are you sure ?" class="btn blue btn-outline">
