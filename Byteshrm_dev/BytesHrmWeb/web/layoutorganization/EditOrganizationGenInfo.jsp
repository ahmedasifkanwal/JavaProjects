                        ...
                        <div class="portlet box blue ">
                            ...
                            <div class="portlet-body">
                                ...
                                <div class="portlet-body form">
                                    <!-- BEGIN FORM-->
                                    <s:form  id="eGeneralInformation" name="eGeneralInformation"  action="eGeneralInformation.itb"   cssClass="login-form" method="post" theme="simple" novalidate="novalidate"  >

                                        <s:hidden name="organizationGenInfo.id" id="organizationGenInfo.id"></s:hidden>
                                            <div class="row " >
                                                ...
                                                <div class="col-md-6">
                                                    <div class="row">
                                                        <div class="col-md-offset-3 col-md-9">
                                                            ...
                                                            <a href="gGeneralInformation.itb?id=<s:property value="%{organizationGenInfo.id}" />" data-toggle="confirmation" data-original-title="Are you sure ?" class="btn blue btn-outline">
