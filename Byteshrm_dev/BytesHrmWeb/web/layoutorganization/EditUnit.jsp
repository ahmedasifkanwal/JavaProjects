                    ...
                    <div class="page-content">
                        ...
                        <div class="portlet box blue ">
                            ...
                            <div class="portlet-body">
                                <s:form  id="eUnit" name="eUnit"  action="eUnit.itb"   cssClass="login-form" method="post" theme="simple" enctype="multipart/form-data" novalidate="novalidate"  >
                                    ...
                                    <div class="form-body">
                                        ...
                                        <s:hidden name="subunit.id" id="subunit.id"></s:hidden>   
                                          <s:hidden name="subunit.level" id="subunit.level"></s:hidden>   
                                        ...
                                        <div class="form-actions">
                                            ...
                                            <a href="mUnit.itb" data-toggle="confirmation" data-original-title="Are you sure ?" class="btn red btn-outline">
                                                <i class="fa fa-remove"></i> Cancel </a>
                                            <a href="gUnit.itb?id=<s:property value="%{subunit.id}" />" data-toggle="confirmation" data-original-title="Are you sure ?" class="btn blue btn-outline">
