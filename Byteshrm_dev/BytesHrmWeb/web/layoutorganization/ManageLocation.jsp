                    ...
                    <div class="page-content">
                        ...
                        <div class="portlet box blue">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="fa fa-map-pin"></i><%=session.getAttribute("SELACTIONNAME")%></div>
                                <div class="tools">
                                 ...
                                 <div class="actions">
                                    <a href="oLocation.itb"   class="btn btn-default btn-sm">
                                        <i class="fa fa-plus"></i> Add Location </a>
                                </div>
                            </div>
                            <div class="portlet-body form">
                                <!-- BEGIN FORM-->
                                <s:form action="mLocation.itb" cssClass="horizontal-form" method="post" theme="simple" id="form_sample_2"  novalidate="novalidate">
                                                ...
                                                <div class="portlet light portlet-fit portlet-datatable bordered">
                                                    ...
                                                    <div class="portlet-body">
                                                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                                            ...
                                                            <tbody>
                                                                <s:iterator var="p" value="locationDto.locationList">
                                                                    <tr class="odd gradeX">
                                                                        <td>
                                                                            <s:property value="%{id}" />
                                                                        </td>
                                                                        ...
                                                                        <td>
                                                                          <s:property value="%{countryCode.couCode}" />
                                                                        </td>
                                                                        ...
                                                                        <td>
                                                                            <a href="gLocation.itb?id=<s:property value="%{id}" />" class="btn btn-outline btn-circle green btn-sm blue-stripe">
