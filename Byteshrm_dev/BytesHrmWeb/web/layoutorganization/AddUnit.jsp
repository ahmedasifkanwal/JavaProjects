                    ...
                    <div class="page-content">
                        ...
                        <div class="portlet box blue ">
                            ...
                            <div class="portlet-body">
                                <s:form  id="aUnit" name="aUnit"  action="aUnit.itb"   cssClass="login-form" method="post" theme="simple" enctype="multipart/form-data" novalidate="novalidate"  >
                                    ...
                                    <div class="form-body">
                                        ...
                                        <s:hidden name="subunitParent.id" id="subunitParent.id"></s:hidden>      
                                        <s:hidden name="subunit.level" id="subunit.level"  value="%{subunitParent.id}"></s:hidden>      
                                        ...
                                        <div class="form-group">
                                            ...
                                            <s:textfield cssClass="form-control"  autocomplete="off"   name="subunit.description" id="description"    />
...
<div class="caption">
                                            ...
                                            <span class="caption-subject font-blue-sunglo bold uppercase">The Unit will be added under:
                                                <span class="caption-subject font-red-sunglo bold"><s:label name="subunitParent.name" /></span>
                                        ...
                                        <div class="form-actions">
                                            ...
                                            <a href="mUnit.itb" class="btn red btn-outline"data-toggle="confirmation" data-original-title="Are you sure ?" >
                                                <i class="fa fa-mail-reply"></i> Cancel </a>
                                            <a href="oUnit.itb" class="btn blue btn-outline" data-toggle="confirmation" data-original-title="Are you sure ?" >
