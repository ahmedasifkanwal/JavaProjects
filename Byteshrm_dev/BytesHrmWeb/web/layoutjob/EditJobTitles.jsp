                    ...
                    <div class="page-content">
                        ...
                        <div class="portlet box blue ">
                            ...
                            <div class="portlet-body">
                                <s:form  id="editjotitle" name="editjotitle"  action="eJobtitles.itb"   cssClass="login-form" method="post" theme="simple" enctype="multipart/form-data" novalidate="novalidate"  >

                                    <s:hidden name="jobTitle.id" id="jobTitle.id"></s:hidden>
                                        <div class="row">
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="control-label">Job Tiles
                                            ...
                                            <s:textfield cssClass="form-control"  autocomplete="off"  
                                                         name="jobTitle.jobTitle" id="jobTitle"   /> 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <s:textfield cssClass="form-control"  autocomplete="off"   name="jobTitle.jobDescription" id="jobDescription"    />
                                        ...
                                        <div class="form-group">
                                            <label class="control-label">Job Specification 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <s:textfield cssClass="form-control"  autocomplete="off"   name="jobTitle.note" id="note"    /> 
                                        </div>
                                        <div class="form-actions">
                                            <a href="mJobTitles.itb" data-toggle="confirmation" data-original-title="Are you sure ?" class="btn red btn-outline">
                                                <i class="fa fa-remove"></i> Cancel </a>
                                            <a href="gJobTitles.itb?id=<s:property value="%{jobTitle.id}" />" data-toggle="confirmation" data-original-title="Are you sure ?" class="btn blue btn-outline">
