                    ...
                    <div class="page-content">
                        ...
                        <div class="portlet box blue ">
                            ...
                            <div class="portlet-body">
                                <s:form  id="aPayGrades" name="ePayGrades"  action="aPayGrades.itb"   cssClass="login-form" method="post" theme="simple"  novalidate="novalidate"  >
                                    <s:hidden name="payGrade.id" id="payGrade.id"></s:hidden>
                                        <div class="row">
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-actions">
                                            ...
                                            <a href="gPayGrades.itb?id=<s:property value="%{payGrade.id}" />" data-toggle="confirmation" data-original-title="Are you sure ?" class="btn blue btn-outline">
                                                <i class="fa fa-remove"></i> Reset </a>
                                            <s:submit   method="edit" data-toggle="confirmation" data-original-title="Are you sure ?" cssClass="btn blue btn-outline"   id="save" key="btn.save" />
                                        </div>
