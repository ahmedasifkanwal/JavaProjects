                    ...
                    <div class="page-content">
                        ...
                        <div class="portlet box blue ">
                            ...
                            <div class="portlet-body">
                                <s:form  id="aJobCategories" name="aJobCategories"  action="aJobCategories.itb"   cssClass="login-form" method="post" theme="simple" novalidate="novalidate"  >
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <a href="oJobCategories.itb" data-toggle="confirmation" data-original-title="Are you sure ?" class="btn blue btn-outline">
