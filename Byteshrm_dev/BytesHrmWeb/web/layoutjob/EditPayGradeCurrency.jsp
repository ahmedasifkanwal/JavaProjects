                    ...
                    <div class="page-content">
                        ...
                        <div class="portlet box blue ">
                            ...
                            <div class="portlet-body">
                                <s:form  id="ePayGradesCurrency" name="ePayGradesCurrency"  action="ePayGradesCurrency.itb"   cssClass="login-form" method="post" theme="simple" enctype="multipart/form-data" novalidate="novalidate"  >
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <s:select cssClass="bs-select form-control" data-live-search="true" data-size="8"  name="payGradeCurrency.currencyType.currencyId"  id="code"  headerValue="Select Currency "   headerKey=""  list="refDto.currencyTypeList"
                                        ...
                                        <div class="form-actions">
                                           <a href="mPayGradeCurrency.itb" data-toggle="confirmation" data-original-title="Are you sure ?" class="btn red btn-outline">
                                                <i class="fa fa-remove"></i> Cancel </a>
                                            <a href="gPayGradeCurrency.itb?id=<s:property value="%{payGradeCurrency.id}" />" data-toggle="confirmation" data-original-title="Are you sure ?" class="btn blue btn-outline">
                                                <i class="fa fa-remove"></i> Reset </a>
                                            <s:submit   method="edit"  cssClass="btn blue btn-outline" data-toggle="confirmation" data-original-title="Are you sure ?" id="save" key="btn.save" />
                                        </div>
