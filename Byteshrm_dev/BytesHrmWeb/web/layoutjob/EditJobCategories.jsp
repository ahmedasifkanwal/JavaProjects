                    ...
                    <div class="page-content">
                        ...
                        <div class="portlet box blue ">
                            ...
                            <div class="portlet-body">
                                <s:form  id="eJobCategories" name="eJobCategories"  action="eJobCategories.itb"   cssClass="login-form" method="post" theme="simple" novalidate="novalidate"  >
                                    <s:hidden name="jobCategory.id" id="jobCategory.id"></s:hidden>
                                        <div class="row">
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="control-label">Job Category
                                        ...
                                        <div class="form-actions">
                                            <a href="mJobCategories.itb" data-toggle="confirmation" data-original-title="Are you sure ?" class="btn red btn-outline">
                                                <i class="fa fa-remove"></i> Cancel </a>
                                            <a href="gJobCategories.itb?id=<s:property value="%{jobCategory.id}" />" data-toggle="confirmation" data-original-title="Are you sure ?" class="btn blue btn-outline">
