                    ...
                    <div class="page-content">
                        ...
                        <div class="portlet box blue ">
                            ...
                            <div class="portlet-body">
                                <s:form  id="eEmploymentStatus" name="eEmploymentStatus"  action="eEmploymentStatus.itb"   cssClass="login-form" method="post" theme="simple" novalidate="novalidate"  >
                                    <s:hidden name="employmentStatus.id" id="employmentStatus.id"></s:hidden>
                                        <div class="row">
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <s:textfield cssClass="form-control"  autocomplete="off"  
                                                         name="employmentStatus.name" id="name"   /> 
                                        ...
                                        <div class="form-actions">
                                            <a href="mEmploymentStatus.itb" data-toggle="confirmation" data-original-title="Are you sure ?" class="btn red btn-outline">
                                                <i class="fa fa-remove"></i> Cancel </a>
                                            <a href="gEmploymentStatus.itb?id=<s:property value="%{employmentStatus.id}" />" data-toggle="confirmation" data-original-title="Are you sure ?" class="btn blue btn-outline">
