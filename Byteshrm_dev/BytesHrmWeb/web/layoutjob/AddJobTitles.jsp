    ...
    <%   if (!session.getAttribute("isPageAuthorized").toString().equalsIgnoreCase("Not Authorized")) {%>
                        ...
                        <div class="portlet box blue ">
                            ...
                            <div class="portlet-body">
                                <s:form  id="addjotitle" name="addjotitle"  action="aJobtitles.itb"   cssClass="login-form" method="post" theme="simple" enctype="multipart/form-data" novalidate="novalidate"  >
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-actions">
                                            ...
                                            <a href="oJobTitles.itb" data-toggle="confirmation" data-original-title="Are you sure ?" class="btn blue btn-outline">
