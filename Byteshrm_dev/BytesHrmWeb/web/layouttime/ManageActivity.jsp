                    ...
                    <div class="page-content">
                        ...
                        <div class="portlet box blue">
                            ...
                            <div class="portlet-body form">
                                <!-- BEGIN FORM-->
                                <s:form action="mActivity.itb" cssClass="horizontal-form" method="post" theme="simple" id="form_sample_2"  novalidate="novalidate">
                                                ...
                                                <div class="portlet light portlet-fit portlet-datatable bordered">
                                                        ...
                                                        <div class="actions">
                                                            ...
                                                            <div class="btn-group">
                                                                ...
                                                                <ul class="dropdown-menu pull-right" id="datatable_ajax_tools">
                                                                    ...
                                                                    <li>
                                                                        <a  class="action" href="oActivityProject.itb">
                                                                            <i class="icon-plus"></i>Add Activity </a>
                                                                    </li>
                                                    ...
                                                    <div class="portlet-body">
                                                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                                            ...
                                                            <tbody>
                                                                <s:iterator var="p" status="rowCount" value="activityDto.activityList">
                                                                    <tr class="odd gradeX">
                                                                        <td>
                                                                        ...
                                                                        <td>
                                                                            <a href="gActivity.itb?activity.id=<s:property value="%{id}" />" class="btn btn-outline btn-circle green btn-sm blue-stripe">
