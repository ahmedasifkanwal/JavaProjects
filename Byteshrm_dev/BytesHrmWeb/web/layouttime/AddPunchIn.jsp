                    ...
                    <div class="page-content">
                        ...
                        <div class="portlet box blue ">
                            ...
                            <div class="portlet-body">
                                <s:form  id="addpunchIn" name="addpunchIn"  action="aPunchIn.itb"   cssClass="login-form" method="post" theme="simple" enctype="multipart/form-data" novalidate="novalidate"  >
                                    ...
                                    <div class="form-body">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <s:textfield cssClass="form-control"  autocomplete="off"  
                                                                 name="" id=""   /> 
                                                    <span> <s:fielderror   fieldName=""/></span>
                                        ...
                                        <div class="row"> 
                                            <div class="col-md-6">       
                                                <div class="form-group">
                                                    ...
                                                    <s:select cssClass="bs-select form-control" data-live-search="true" data-size="8"  name=""  id=""  headerValue="Select Timezone "   headerKey=""  list="refDto."
                                        ...
                                        <div class="form-actions">
                                            <a href="mPunchIn.itb" data-toggle="confirmation" data-original-title="Are you sure ?" class="btn red btn-outline">
                                                <i class="fa fa-mail-reply"></i> Cancel </a>
                                            <a href="oPunchIn.itb" data-toggle="confirmation" data-original-title="Are you sure ?" class="btn blue btn-outline">
