                    ...
                    <div class="page-content">
                        ...
                        <div class="portlet box blue ">
                            ...
                            <div class="portlet-body">
                                <s:form  id="addattendanceconfiguration" name="addattendanceconfiguration"  action="aAttendanceConfiguration.itb"   cssClass="login-form" method="post" theme="simple" enctype="multipart/form-data" novalidate="novalidate"  >
                                    ...
                                    <div class="form-body">
                                        <div class="row"> 
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <div class="col-md-10">
                                                        <label class="control-label">Employee can change current time when punching in/out </label>
                                                    </div>
                                                    <div class="col-md-2">
                                        ...
                                        <div class="row"> 
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <div class="col-md-10">
                                                        <label class="control-label">Employee can edit/delete own attendance records </label>
                                                    </div>
                                                    <div class="col-md-2">
                                        ...
                                        <div class="row"> 
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <div class="col-md-10">
                                                        <label class="control-label">Supervisor can add/edit/delete attendance records of subordinates </label>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <input type="checkbox" id="inlineCheckbox23" value="option1">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-actions">
                                            <a href="mAttendanceConfiguration.itb" data-toggle="confirmation" data-original-title="Are you sure ?" class="btn red btn-outline">
                                                <i class="fa fa-mail-reply"></i> Cancel </a>
                                            <a href="oAttendanceConfiguration.itb" data-toggle="confirmation" data-original-title="Are you sure ?" class="btn blue btn-outline">
