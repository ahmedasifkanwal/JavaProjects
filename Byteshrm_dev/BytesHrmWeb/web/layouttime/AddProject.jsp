                    ...
                    <div class="page-content">
                        ...
                        <div class="portlet box blue ">
                            ...
                            <div class="portlet-body">
                                <s:form  id="addproject" name="addproject"  action="aProject.itb"   cssClass="login-form" method="post" theme="simple" enctype="multipart/form-data" novalidate="novalidate"  >
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="row"> 
                                            <div class="col-md-6">       
                                                <div class="form-group">
                                                    <label class="control-label">Project Admin
                                                        <span class="required" aria-required="true"> </span>
                                                    </label>
                                                    <s:textfield cssClass="form-control"  autocomplete="off"  
                                                                 name="" id=""   /> 
                                        ...
                                        <div class="form-actions">
                                            <a href="mProject.itb" data-toggle="confirmation" data-original-title="Are you sure ?" class="btn red btn-outline">
                                                <i class="fa fa-mail-reply"></i> Cancel </a>
                                            <a href="oProject.itb" data-toggle="confirmation" data-original-title="Are you sure ?" class="btn blue btn-outline">
